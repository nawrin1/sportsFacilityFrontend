...
import { AiOutlineMenu } from "react-icons/ai"; // Icon for the drawer toggle button
      ...
      <div className="drawer-side">
        ...
        <ul className="menu p-4 w-60 min-h-full bg-[#fffff2] text-base-content shadow-xl">
          <h2 className="text-3xl text-blue-950 font-semibold text-center mb-7 font-serif">
            <p><MdOutlineDashboardCustomize /></p>Dashboard
          </h2>
          <li className="font-semibold text-lg text-center flex justify-center hover:text-[#fffff2] items-center hover:bg-[#414141]">
            <NavLink
              to="/"
              className={({ isActive }) => isActive ? "actives hover:text-white flex items-center gap-3 p-2 rounded transition duration-200" : "flex items-center gap-3 p-2 rounded transition duration-200"}
            >
